 ...
 *
 */
public class FabriqueLabyrintheParfait extends FabriqueLabyrinthe{

	/**
	 * Constructeur de FabriqueLabyrintheParfait
	 * @param g : le gestionnaire
	 */
	public FabriqueLabyrintheParfait(Gestionnaire g) {
		super(g);
	}
	
	/**
	 * Methode qui permet de creer un labyrinthe parfait grâce un algorithme de fusion
	 */
	@Override
	public Labyrinthe fabriquerLabyrinthe() {
		...
		l.positionnerEntree(l.getCarte()[1][1]);
