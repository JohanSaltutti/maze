...
public class PanneauAStar extends PanneauAlgoGlobal {
	...
	/**
	 * Constructeur de PanneauAStar
	 * @param g : le gestionnaire
	 * @param a : l'algorithme
	 */
	public PanneauAStar(Gestionnaire g, Algorithme a) {
		super(g, a);
	}
	
	/**
	 * Methode permettant de retourner la vue
	 */
	@Override
	...
	/**
	 * Methode permettant de construire la legende
	 */
	@Override
